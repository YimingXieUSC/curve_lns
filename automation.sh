...
name="warehouse-20-40-10-2-2-10000agents"
map="/home/trojan/Desktop/curve/MAPF-LNS2/maps/$name.map"
scen="/home/trojan/Desktop/curve/MAPF-LNS2/instances/$name"
...
do
    ...
    echo "destination: "
    /home/trojan/Desktop/curve/MAPF-LNS2/build/lns -m $map -a $scen-$i.scen -k $n -o $output-$n-$w-$sid-GRID.csv -t $time
done
