...
int main(int argc, char** argv)
{
	...
	desc.add_options()
        ...
        ("maxIterations", po::value<int>()->default_value(20), "maximum number of iterations")
        ...
        ("destoryStrategy", po::value<string>()->default_value("GridCollision"),
                "Heuristics for finding subgroups (Random, RandomWalk, Intersection, Adaptive, GridCollision)")
